...
PGM_P(letraa)="a";  PGM_P(letraA)="A";
PGM_P(letrab)="b";  PGM_P(letraB)="B";
PGM_P(letrac)="c";  PGM_P(letraC)="C";
PGM_P(letrad)="d";  PGM_P(letraD)="D";
PGM_P(letrae)="e";  PGM_P(letraf)="f";
PGM_P(letraF)="F";  
PGM_P(letrag)="g";  PGM_P(letraG)="G";  
PGM_P(letrah)="h";  PGM_P(letraH)="H";  
PGM_P(letrai)="i";  PGM_P(letraI)="I";
PGM_P(letraJ)="J";
PGM_P(letral)="l";  PGM_P(letraL)="L";
PGM_P(letrak)="k";  PGM_P(letraK)="K";
PGM_P(letram)="m";  PGM_P(letraM)="M";
PGM_P(letran)="n";  PGM_P(letraN)="N";
PGM_P(letrao)="o";  PGM_P(letraO)="O";
PGM_P(letrap)="p";  PGM_P(letraP)="P";
PGM_P(letrar)="r";  PGM_P(letraR)="R";
PGM_P(letras)="s";  PGM_P(letraS)="S";
PGM_P(letrat)="t";  PGM_P(letraT)="T";
PGM_P(letrau)="u";  PGM_P(letraU)="U";
PGM_P(letrav)="v";  PGM_P(letraV)="V";
PGM_P(letraw)="w";  PGM_P(letraW)="W";
PGM_P(letraX)="X";  PGM_P(letray)="y";
PGM_P(letraZ)="Z";
PGM_P(cero)="0";
PGM_P(uno)="1";
PGM_P(dos)="2";
